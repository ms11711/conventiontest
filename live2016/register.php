...
$('#country').change(function(){
    ...
    if (country == "USA"){
        ...
        $("#state_dropin").removeAttr('name');
        $('#state_dropdown').show();
        $("#state_dropsel").attr("required", "required");
        $("#state_dropsel").attr("name", "state");
    }
    else {
        $('#state_dropdown').hide();
        $("#state_dropsel").removeAttr('required');
        $("#state_dropsel").removeAttr('name');
        $('#state_input').show();
        $("#state_dropin").attr("required", "required");
        $("#state_dropin").attr("name", "state");
    }
});
