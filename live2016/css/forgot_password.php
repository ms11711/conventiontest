...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $message_sent = Auth::getInstance()->sendPasswordReset($_POST['email']);
}
...
<div class="row">
    ...
    <h1 class="header">Forgotton Password</h1>
...
<?php if (isset($message_sent)): ?>
    ...
    <?php if ($message_sent == true) {
        echo "<p>A confirmation email has been mailed.Please check your mail box for the token link</p>";
    } else {
...
<?php else: ?>
    ...
    <form method="post">
        ...
        <div class="row">
          <button class="btn-large waves-effect waves-light" type="submit">Reset Password
