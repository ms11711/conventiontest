...
$query = "SELECT * FROM readyrooms";
$complete = User::getAllData($query);
...
<script type="text/javascript" src="/js/bootstrap-datetimepicker.min.js"></script>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h4>If you see your ID number in the list below, please come see the room key desk next to souvenirs and pick up a room key.</h4><p>You can find your ID number on the top left corner of your badge.</p>

            <?php 
 
            for($i = 0; $i <sizeof($complete);$i++){

                $roomnumber = $complete[$i]["roomnum"];
                //echo $complete[$i]["roomnum"]."<br>";

                $query = "SELECT id FROM roomlist WHERE room = ".$roomnumber."";
