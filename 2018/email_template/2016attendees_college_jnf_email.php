...
$SQL = "SELECT * from user_details INNER JOIN user_misc ON user_details.id = user_misc.id WHERE user_details.agegroup = 'JNF' AND user_details.jnfbook_optin = '1' AND user_misc.completed_registration = '1'";
