...
<html lang="en">
    <head>
        ...
        <title><?php echo $config_title; ?> | Social Programming</title>
    ...
    <body>
       ...
       <?php include "config/nav.php" ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 margin30">
                    <h3 class="heading">Formal: Maharaja’s Court</h3>
                    <p>Picture sparkling jewelry, lavish tapestries, intricate art. Think royalty. Maharaja’s Court will transport you to the luxurious worlds of India’s legendary emperors and empresses, but with a modern twist. Ladies and gentlemen, we highly encourage you to come dressed in Indian reception attire! This means ladies have the option of wearing Indian clothes (i.e. sari, lehnga choli, salwar kameez/anarkali) or long American gowns; men may also don their Indian clothes (i.e. sherwani, kurta pajama) or black tie attire (i.e. suit and tie/bow tie). Get ready for a night of opulence, dance, and fun!</p>
                </div>
                <div class="col-md-4 margin30">
                    <p style="text-align:center;"><img src="images/formal.jpg" height="265" alt=""></p>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 margin30">   
                    ...
                    <h4 style="text-align:center;">Garba: Straight Outta Gujarat</h4>
                    <p style="text-align:center;">If you have ever wanted to garba in the Hills, play dandiya by the palm trees, or sanedo by the beach, this is the event for you! Look forward to a night of classic fun with a new flair! This event is taking us straight outta Gujarat and adding a SoCal touch! Dress code is traditional garba attire for ladies (i.e. Chanya Choli, Salwar Kamize, Sari) and traditional Indian attire for gentlemen (i.e. Kurta Pyjama, Sherwani, Dhoti/Kurta).</p>
                </div>
            </div>

            <div class="row">
                <div class="col-md-12 margin30">
                    <p style="text-align:center;"><em>Please note that social events are subject to change.</em></p>
                </div>
            </div>
